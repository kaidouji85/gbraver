describe('Battleクラスのテスト', function() {
    ...
    describe('パイロットスキル発動',function(){
        it('自分ターン発動の回復スキル',function(){
            ...
            Battle.doPilotSkill();
            var statusArray = Battle.getStatusArray();
            assert.equal(statusArray['test001@gmail.com'].hp,3000,'test001@gmail.comのHPが1000回復する。');
            ...
            assert.equal(statusArray['test002@gmail.com'].hp,4700,'test002@gmail.comのHPが回復しない。');
            assert.equal(statusArray['test002@gmail.com'].battery,5,'test002@gmail.comのHPが回復しない。');
        });
    });
}); 